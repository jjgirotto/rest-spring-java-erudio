...
import br.com.erudio.rest_spring_java_erudio.unittests.mapper.mocker.MockPerson;
...
class PersonServiceTest {
    ...
    @InjectMocks
    private PersonService service; //do not access the real repo, return mock
    ...
    void findById() throws Exception {
        Person entity = input.mockEntity(1); //returns a person withoud an id
    ...
    @Test
    void delete() {
        Person entity = input.mockEntity(1); //returns a person without an id
        entity.setId(1L); //define the id
